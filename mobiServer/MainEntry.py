...
if __name__ == "__main__":
    ...
    TCP_HOST = ("160.36.26.199", 11314);
    UDP_HOST = ("160.36.26.199", 11315);
    FTP_HOST = ("160.36.26.199", 11316);
    
    cmd = raw_input("TCP, UDP, FTP service: ");
    
    if cmd == "TCP" or cmd == "tcp":
        tcpServer = ThreadedTCPServer(TCP_HOST, ThreadedTCPRequestHandler);
        ...
        udpServer = ThreadedUDPServer(UDP_HOST, ThreadedUDPRequestHandler);
        ...
        ftpServer = ThreadedFileSocketServer(FTP_HOST, ThreadedFileSocketRequestHandler);
